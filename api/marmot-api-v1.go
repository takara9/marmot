...
type VirtualNetworkSpec struct {
	...
	// OverlayMode Overlay mode for multi-node networks: 'none' (default) or 'vxlan' (deprecated). OVN-managed mode will be added in a future release.
	OverlayMode *VirtualNetworkSpecOverlayMode `json:"overlayMode,omitempty" yaml:"overlayMode,omitempty"`

	// PeerPolicy Policy for peer management: 'auto' or 'manual'. This field may be ignored by future OVN-managed mode.
	...
	// Vni Overlay VNI (0-16777215).
	Vni *int `json:"vni,omitempty" yaml:"vni,omitempty"`
}

// VirtualNetworkSpecOverlayMode Overlay mode for multi-node networks: 'none' (default) or 'vxlan' (deprecated). OVN-managed mode will be added in a future release.
type VirtualNetworkSpecOverlayMode string

// VirtualNetworkSpecPeerPolicy Policy for peer management: 'auto' or 'manual'. This field may be ignored by future OVN-managed mode.
