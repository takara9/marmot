...
func generate_vars(cnf cf.MarmotConfig, fn string) {
	...
	vars_file.WriteString("## Generated by mactl gen-inv\n")
	vars_file.WriteString("nodes:\n")
...
func generate_hosts(cnf cf.MarmotConfig, fn string) error {
	...
	hosts_file.WriteString("## Generated by mactl gen-inv\n")
...
func generate_inventory(cnf cf.MarmotConfig) error {
	...
	// インベントリ書き込み
	inventory_file.WriteString("# Generate by mactl gen-inv\n")
