...
var _ = Describe("Etcd", Ordered, func() {
	...
	BeforeAll(func(ctx SpecContext) {
		...
		cmd := exec.Command("docker", "run", "-d", "--name", "etcd0", "-p", "4379:2379", "-p", "4380:2380", "-e", "ALLOW_NONE_AUTHENTICATION=yes", "-e", "ETCD_ADVERTISE_CLIENT_URLS=http://127.0.0.1:3379", "bitnami/etcd")
