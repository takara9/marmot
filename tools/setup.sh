...
mc cp myminio/os-image/jammy-server-cloudimg-amd64.img jammy-server-cloudimg-amd64.img
...
qemu-img create -f qcow2 /var/lib/libvirt/images/data-vol-1.qcow2 1G
qemu-img create -f qcow2 /var/lib/libvirt/images/data-vol-2.qcow2 1G
